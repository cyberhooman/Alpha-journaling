  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div custom={0} variants={fadeUp} initial="hidden" animate="visible">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">Advanced Analytics</h1>
      ...
      <motion.div custom={5} variants={fadeUp} initial="hidden" animate="visible" className="card p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <h3 className="text-base font-semibold text-gray-900 dark:text-white">Performance by Strategy</h3>
          </div>
        </div>
      ...
      <motion.div custom={6} variants={fadeUp} initial="hidden" animate="visible" className="card p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <p className="text-xs uppercase tracking-widest text-[#555]">Breakdown</p>
            <h3 className="text-base font-semibold text-gray-900 dark:text-white">Performance by Setup</h3>
          </div>
        </div>
        <ResponsiveContainer width="100%" height={280}>
      ...
      <motion.div custom={7} variants={fadeUp} initial="hidden" animate="visible" className="card p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <h3 className="text-base font-semibold text-gray-900 dark:text-white">Win Rate by Day of Week</h3>
          </div>
        </div>
        <ResponsiveContainer width="100%" height={280}>
