    ...
    <div className="space-y-8">
      ...
      >
        <div>
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white">Strategy Library</h1>
      ...
      {strategies.length === 0 ? (
        ...
        >
          ...
          <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">No Strategies Yet</h3>
                  ...
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap mb-2">
                        <h3 className="text-base font-bold text-gray-900 dark:text-white">{strategy.name}</h3>
